...
* hosting a capability statement at [url]/metadata that is available to both authenticated and unauthenticated clients and that declares that AU eRequesting is supported using CapabilityStatement.instantiates, as shown in the following fragment:
    ...
    ```
    {
      ...
      ...
      "instantiates": [
        "http://ontotestig.csiro.au/fhir/CapabilityStatement/au-erequesting-server"
      ],
      ...  
      "rest": [
        {
...
~~~
{
  ...
  ...
  "url" : "http://ontotestig.csiro.au/fhir/StructureDefinition/au-erequesting-communicationrequest-copyto",   
  ...
      {
        ...
        "extension" : [            
            {
              "extension" : [
                {
                  "url" : "actor",
                  "valueCanonical" : "http://ontotestig.csiro.au/fhir/ActorDefinition/au-erequesting-actor-placer"
                },
                {
                  "url" : "code",
