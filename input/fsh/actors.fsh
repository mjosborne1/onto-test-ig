...
Usage: #definition
* url = "http://ontotestig.csiro.au/fhir/ActorDefinition/au-erequesting-actor-placer"
...
* capabilities = "http://ontotestig.csiro.au/fhir/CapabilityStatement/au-erequesting-placer"

Instance: au-erequesting-actor-filler
InstanceOf: ActorDefinition
Usage: #definition
* url = "http://ontotestig.csiro.au/fhir/ActorDefinition/au-erequesting-actor-filler"
...
* capabilities = "http://ontotestig.csiro.au/fhir/CapabilityStatement/au-erequesting-filler"

Instance: au-erequesting-actor-patient
InstanceOf: ActorDefinition
Usage: #definition
* url = "http://ontotestig.csiro.au/fhir/ActorDefinition/au-erequesting-actor-patient"
...
* capabilities = "http://ontotestig.csiro.au/fhir/CapabilityStatement/au-erequesting-patient"

Instance: au-erequesting-actor-server
InstanceOf: ActorDefinition
Usage: #definition
* url = "http://ontotestig.csiro.au/fhir/ActorDefinition/au-erequesting-actor-server"
...
* capabilities = "http://ontotestig.csiro.au/fhir/CapabilityStatement/au-erequesting-server"
